...
dens1 = 0 #density 1
dens2 = 0 #density 2
# these are all global placeholders for the tk labels inside the table of values
Distance_1 = None
Distance_2 = None
Mass_1 = None
Mass_2 = None
...
class Window(): #class of the main window where the simulation will run
    ...
    def createTableOfValues(self, simFrame, main):
        ...
        #import all the global variables - the variables not visible are listed in the global variables
        
        TableOfValues = Tk() # define the window for the table of values
        TableOfValues.title("Table of Values")
        TableOfValues.geometry("500x600+0+200")
        
        Obj1 = tk.Label(TableOfValues, text = "Object 1", font = ("", 12)) # labels for object 1 and object 2
        Obj1.place(x=225, y=5)
        Obj2 = tk.Label(TableOfValues, text = "Object 2", font = ("", 12))
        Obj2.place(x=385, y=5)
        
        Mass = tk.Label(TableOfValues, text = "Mass (kg)", font = ("", 12)) # labels for the left hand side of the table
        Mass.place(x=5, y=50)
        ...
        vert_line1 = tk.Canvas(TableOfValues, width = 2, height = 485, bg = "black", relief = FLAT, borderwidth = 0) # lines to create table shape
        ...
        Mass_1 = tk.Label(TableOfValues, text = (round(m1, 2)), font = ("",12)) # values placed as labels inside table using the global variables
    ...
    def Update(self, simFrame):
        ...
        if scenario_choice == 0: # do a specific action according to user scenario choice
            None #do nothing
        ...
        Distance_1.config(text = (d)) # update the table with the new values
        ...
        simFrame.after(int(round((1000/fps),0))) # calculate update time
        simFrame.update() # update canvas for the user
