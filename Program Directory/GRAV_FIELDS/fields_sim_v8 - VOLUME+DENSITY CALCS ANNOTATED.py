...
#Version 8:
# added calculation of densities/volumes
...
fps = int(15) # frames per second the sim is run at
...
class Window(): #class of the main window where the simulation will run
    ...
    class Object(): # class of the object - creates instances of objects using OOP
        ...
        def calcVolume(self, simFrame): # calculate volumes
            global m1, m2, d, PI
        ...
        def calcDensity(self, vol_obj1, vol_obj2, simFrame): # calculate densities
            global m1, m2
    ...
    def enterScenario(self, fpsSelect, m1Select, m2Select, dSelect, startButton, simFrame, main):
        ...
        confirmButton = tk.Button(scenarioWindow, text = "CONFIRM AND START", fg = "white", bg = "black")
    ...
    def Update(self, simFrame):
        global m1, m2, d, scenario_choice, fps # import global variables
        
        simFrame.delete("all") # delete all objects in canvas
        
        Object1 = self.Object(m1, d, simFrame) # initialise objects
        Object2 = self.Object(m2, d, simFrame)
        
        G_Force = Object1.calcGravForce(simFrame) # calculate values - including vol/density
        ...
        Vol_1, Vol_2 = Object1.calcVolume(simFrame)
        Dens_1, Dens_2 = Object1.calcDensity(Vol_1, Vol_2, simFrame)
        
        G_Force_StatusMsg = tk.Label(simFrame, text = ("Grav force:",G_Force*(10**15),"fN"), fg = "white", bg = "black", font = ("Dotum", 8)) # status messages
        ...
        Vol_1_StatusMsg = tk.Label(simFrame, text = ("Volume [obj 1]:",Vol_1,"m^3"), fg = "white", bg = "black", font = ("Dotum", 8)) # vol status messages
        Vol_1_StatusMsg.place(x = 5, y = 165)
        Vol_2_StatusMsg = tk.Label(simFrame, text = ("Volume [obj 2]:",Vol_2,"m^3"), fg = "white", bg = "black", font = ("Dotum", 8))
        Vol_2_StatusMsg.place(x = 5, y = 185)
        
        Dens1_StatusMsg = tk.Label(simFrame, text = ("Density [obj 1]:",Dens_1,"kg/m^3"), fg = "white", bg = "black", font = ("Dotum", 8)) # density status messages
        Dens1_StatusMsg.place(x = 5, y = 205)
        Dens2_StatusMsg = tk.Label(simFrame, text = ("Density [obj 2]:",Dens_2,"kg/m^3"), fg = "white", bg = "black", font = ("Dotum", 8))
        Dens2_StatusMsg.place(x = 5, y = 225)
        
        if scenario_choice == 0: # do certain actions according to user scenario choice
            None #do nothing
        ...
        simFrame.after(int(round((1000/fps),0))) # fps value calculation
        simFrame.update() # update canvas for user
        
        G_Force_StatusMsg.destroy() # destroy status messages
