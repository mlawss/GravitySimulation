...
class Window(): #class of the main window where the simulation will run
    ...
    def enterScenario(self, m1Select, m2Select, dSelect, startButton, simFrame, main):
        global m1, m2, d
        ...
        confirmButton = tk.Button(scenarioWindow, text = "Confirm", fg = "white", bg = "black")
    ...
    def confirmScenario(self, confirmButton, scenarioEntry, scenarioWindow, m1Select, m2Select, dSelect, startButton, simFrame, main):
        ...
        while valid == False:
            try:
                ...
                valid = True
                self.runSim(m1Select, m2Select, dSelect, startButton, simFrame, main)
                break
            except:
...
##        KE_2_StatusMsg.place(x = 5, y = 145)
        ...
        #simFrame.after(1000/fps_choice)
        simFrame.after(32)
        simFrame.update()
