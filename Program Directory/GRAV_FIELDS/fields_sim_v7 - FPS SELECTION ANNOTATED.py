...
class Window(): #class of the main window where the simulation will run
    ...
    def Update(self, simFrame):
        global m1, m2, d, scenario_choice, fps # import global variables, including fps
        ...
        #status messages of values in canvas
        ...
        #do specific actions according to scenario choice
        ...
        simFrame.after(int(round((1000/fps),0)))#works out the value for the milliseconds between each update, to the nearest integer.
        simFrame.update() # update canvas to user
        
        G_Force_StatusMsg.destroy()# destroy all status messages
