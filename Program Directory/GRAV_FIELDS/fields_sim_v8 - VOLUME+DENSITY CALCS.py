...
class Window(): #class of the main window where the simulation will run
    ...
    def Update(self, simFrame):
        global m1, m2, d, scenario_choice, fps
        ...
        G_Force = Object1.calcGravForce(simFrame)
        ...
        Vol_1_StatusMsg = tk.Label(simFrame, text = ("Volume [obj 1]:",Vol_1,"m^3"), fg = "white", bg = "black", font = ("Dotum", 8))
        ...
        Dens1_StatusMsg = tk.Label(simFrame, text = ("Density [obj 1]:",Dens_1,"kg/m^3"), fg = "white", bg = "black", font = ("Dotum", 8))
